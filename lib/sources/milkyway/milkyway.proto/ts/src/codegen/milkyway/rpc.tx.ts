...
export const createRPCMsgClient = async ({
  ...
  milkyway: {
    assets: {
      v1: new (await import("./assets/v1/messages.rpc.msg")).MsgClientImpl(rpc)
    },
    liquidvesting: {
      v1: new (await import("./liquidvesting/v1/messages.rpc.msg")).MsgClientImpl(rpc)
    },
    operators: {
      v1: new (await import("./operators/v1/messages.rpc.msg")).MsgClientImpl(rpc)
    },
    restaking: {
      v1: new (await import("./restaking/v1/messages.rpc.msg")).MsgClientImpl(rpc)
    },
    rewards: {
      v1: new (await import("./rewards/v1/messages.rpc.msg")).MsgClientImpl(rpc)
    },
    services: {
      v1: new (await import("./services/v1/messages.rpc.msg")).MsgClientImpl(rpc)
    }
  }
});