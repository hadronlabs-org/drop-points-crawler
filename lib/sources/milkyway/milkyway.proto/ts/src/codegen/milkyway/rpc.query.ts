...
export const createRPCQueryClient = async ({
  ...
  return {
    ...
    milkyway: {
      ...
      liquidvesting: {
        v1: (await import("./liquidvesting/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      operators: {
        v1: (await import("./operators/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      pools: {
        v1: (await import("./pools/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      restaking: {
        v1: (await import("./restaking/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      rewards: {
        v1: (await import("./rewards/v1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      services: {
        v1: (await import("./services/v1/query.rpc.Query")).createRpcQueryExtension(client)
      }
    }
  };
};