...
export const QueryDesc = {
  serviceName: "pryzm.mint.v1.Query"
};
...
export const QueryMinterDesc: UnaryMethodDefinitionish = {
  methodName: "Minter",
  service: QueryDesc,
  requestStream: false,
  responseStream: false,
  requestType: {
    serializeBinary() {
      return QueryMinterRequest.encode(this).finish();
    }
  } as any,
  responseType: {
    deserializeBinary(data: Uint8Array) {
      return {
        ...QueryMinterResponse.decode(data),
        toObject() {
          return this;
        }
      };
